      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 fw-semibold">
            ...
            <li class="nav-item">
              <a class="nav-link primerElemento" href="agregaralimento.html">Agregar Alimento</a>
            </li>
            <li class="nav-item">
          ...
          <div class="dropdown">
            <a class="link-secondary me-3 dropdown-toggle hidden-arrow" href="#" id="navbarDropdownMenuLink"
              ...
              <ul class=" dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
                ...
                <li>
                  <a class="dropdown-item" href="noticias.html">Cerrar Sesion</a>
                </li>
                </ul>
          </div>
        </div>
    ...
    <div class="container-add">
      <div class="row justify-content-center d-flex align-items-center">
        <div class="col-sm fs-4">
          <p class="fw-semibold info_alimento cursor-pointer mt-3">Huevo entero</p>
        </div>
